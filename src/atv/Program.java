...
public class Program {
	...
	public static void main(String[] args) {
		...
		Funcionario funcionario1 = new Funcionario("Joao","0123456789",TipoDeDocumento.CNPJ);
		Contratacao contratacao1 = new Contratacao(date,Cargo.ANALISTA,funcionario1);
		Funcionario funcionario2 = new Funcionario("Claudio","42342342",TipoDeDocumento.CPF);
